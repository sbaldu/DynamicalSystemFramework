...
static_assert(is_node<std::shared_ptr<Node<uint8_t, uint8_t>>>::value);
static_assert(is_node<std::shared_ptr<Node<uint16_t, uint16_t>>>::value);
static_assert(is_node<std::shared_ptr<Node<uint32_t, uint32_t>>>::value);
...
static_assert(is_node_v<std::shared_ptr<Node<uint8_t, uint8_t>>>);
static_assert(is_node_v<std::shared_ptr<Node<uint16_t, uint16_t>>>);
static_assert(is_node_v<std::shared_ptr<Node<uint32_t, uint32_t>>>);
