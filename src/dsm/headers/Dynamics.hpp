...
public:
  ...
  /// @return Measurement The mean density of the streets and the standard
  /// deviation
  Measurement streetMeanDensity() const;
  /// @brief Get the mean flow of the streets in \f$s^{-1}\f$
  /// @return Measurement The mean flow of the streets and the standard
  /// deviation
  ...
  /// the computation
  /// @return Measurement The mean spire input flow of the streets and the
  /// standard deviation
  ...
  /// the computation
  /// @return Measurement The mean spire output flow of the streets and the
  /// standard deviation
